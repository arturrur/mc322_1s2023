...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		PrimSeguradora.lerArquivo("veiculos");
		PrimSeguradora.lerArquivo("frotas");
		
		System.out.println("LENDO CLIENTEPJ E CADASTRANDO SUAS RESPECTIVAS FROTAS: ");
		PrimSeguradora.lerArquivo("clientesPJ");
		System.out.println();
		System.out.println();
		System.out.println("LENDO CLIENTEPF E CADASTRANDO SEUS RESPECTIVOS VEICULOS:");
		PrimSeguradora.lerArquivo("clientesPF");
		PrimSeguradora.lerArquivo("condutores");
		
		System.out.println();
		
		//GERA ARQUIVOS CSV E GUARDA DADOS NELES
		System.out.println("Gerando o arquivo seguros.csv e gravando dados nele:");
		PrimSeguradora.gravarArquivo("seguros");
		System.out.println();
		System.out.println("Gerando o arquivo sinistros.csv e gravando dados nele:");
		PrimSeguradora.gravarArquivo("sinistros");
